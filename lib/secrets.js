/**
 * @fileoverview Encrypted private key storage.
 ...
 * @param {string} options.didIdentifier - Method-specific ID (part after did:cel:).
...
async function _decrypt(encoded, password) {
