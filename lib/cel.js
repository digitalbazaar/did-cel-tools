...
import {callWitness} from './witness.js';

const {purposes: {AssertionProofPurpose}} = jsigs;
const jdl = new JsonLdDocumentLoader();

const HMBD_WITNESS_URL = 'https://localhost:22443/witnesses/test/witness';
...
export async function witness({cel, options}) {
  ...
  const proof = await callWitness({digestMultibase, witnessUrl: HMBD_WITNESS_URL});
